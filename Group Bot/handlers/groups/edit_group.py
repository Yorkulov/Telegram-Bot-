...
@dp.message_handler(IsGroup(), Command("set_photo", prefixes="!/z"), AdminFilter())
...
@dp.message_handler(IsGroup(), Command("set_title", prefixes="!/z"), AdminFilter())
...
@dp.message_handler(IsGroup(), Command("set_description", prefixes="!/z"), AdminFilter())
